...
| Host followers | `host_followers` | Follow | Me + host lists | Marketing opt-in | Unfollow | Hard unfollow today | `/dashboard/following`, `/host/followers` | `/crm/follow*` | complete | Optional: soft unfollow history |
...
| Event memories | `event_memories`, `event_memory_media` | Auto on complete | Public/host/admin | Host PATCH; admin moderate | Soft hide; media DELETE | Media hard OK | `/host/events/[id]/memory*` | `/memories/*` | **complete** | Host unpublish only via admin |
