...
_HANDLERS: dict[str, Handler] = {
    ...
    "get_public_pricing": public_search.get_public_pricing,
    "search_public_sponsors": public_search.search_public_sponsors,
    ...
    "get_my_ticket_summary": fan.get_my_ticket_summary,
    ...
    "get_my_fan_connect_inbox_summary": insights.get_my_fan_connect_inbox_summary,
    "get_my_audience_summary": insights.get_my_audience_summary,
    "get_my_event_analytics": insights.get_my_event_analytics,
    "list_my_audience_segments": insights.list_my_audience_segments,
    "get_my_announcements_summary": insights.get_my_announcements_summary,
    "get_my_host_ambassador_analytics": insights.get_my_host_ambassador_analytics,
    ...
    "get_my_ambassador_earnings": ambassador.get_my_ambassador_earnings,
    "list_my_ambassador_campaigns": ambassador.list_my_ambassador_campaigns,
    "list_my_referral_links": ambassador.list_my_referral_links,
    ...
    "get_my_sponsor_overview": sponsor.get_my_sponsor_overview,
    "list_my_sponsor_campaigns": sponsor.list_my_sponsor_campaigns,
    "list_my_sponsor_deals": sponsor.list_my_sponsor_deals,
    "list_my_sponsor_workspaces": sponsor.list_my_sponsor_workspaces,
