...
export default function AdminEventBuyersPage() {
  ...
  return (
    <DashboardShell
      ...
      compact
      eyebrow="Admin"
      title={event ? event.title : "Event buyers"}
      description="Platform buyer list and audited export. Private contact and finance fields require elevated permissions and a reason."
      actions={
    ...
    >
      ...
      {!event ? (
        ...
        <AdminEventBuyersPanel eventId={params.id} mode="buyers" />
      )}
    </DashboardShell>
  );
}
