...
export const authFieldOnDarkControlClass =
  "auth-field-on-dark !border-white/20 !bg-[#141414] !text-white !shadow-none placeholder:!text-white/45 hover:!border-white/30 focus:!border-[#8EF012] focus:!ring-[#8EF012]/35 focus:!ring-offset-0 focus:!ring-offset-transparent read-only:!bg-[#141414] read-only:!text-white disabled:!bg-[#141414] disabled:!text-white/55 [color-scheme:dark] ![transition-property:border-color] ![transition-duration:150ms]";
