...
export const TrackedAction = {
  ...
  MEMORY_LIGHTBOX_NEXT: "memory_lightbox_next",
  MEMORY_LIGHTBOX_PREVIOUS: "memory_lightbox_previous",
  MEMORY_LOAD_MORE: "memory_load_more",
  ...
  LEGACY_SUMMARY_VIEW: "legacy_summary_view",
  LEGACY_DETAILS_OPEN: "legacy_details_open",
  LEGACY_HOW_IT_WORKS_CLICK: "legacy_how_it_works_click",
  LEGACY_NEXT_TIER_VIEW: "legacy_next_tier_view",
  HOST_LEGACY_DASHBOARD_VIEW: "host_legacy_dashboard_view",
  HOST_LEGACY_FACTOR_EXPAND: "host_legacy_factor_expand",
  HOST_LEGACY_REQUIREMENTS_VIEW: "host_legacy_requirements_view",
  HOST_LEGACY_RECALCULATE_REQUEST: "host_legacy_recalculate_request",
...
> = {
  ...
  [TrackedAction.MEMORY_IMPRESSION]: { group: "detail", trust: "client" },
  [TrackedAction.MEMORY_OPEN]: { group: "detail", trust: "client" },
  [TrackedAction.MEMORY_LIGHTBOX_NEXT]: { group: "detail", trust: "client" },
  [TrackedAction.MEMORY_LIGHTBOX_PREVIOUS]: { group: "detail", trust: "client" },
  [TrackedAction.MEMORY_LOAD_MORE]: { group: "detail", trust: "client" },
  ...
  [TrackedAction.LEGACY_SUMMARY_VIEW]: { group: "vault_legacy", trust: "client" },
  [TrackedAction.LEGACY_DETAILS_OPEN]: { group: "vault_legacy", trust: "client" },
  [TrackedAction.LEGACY_HOW_IT_WORKS_CLICK]: { group: "vault_legacy", trust: "client" },
  [TrackedAction.LEGACY_NEXT_TIER_VIEW]: { group: "vault_legacy", trust: "client" },
  [TrackedAction.HOST_LEGACY_DASHBOARD_VIEW]: { group: "vault_legacy", trust: "client" },
  [TrackedAction.HOST_LEGACY_FACTOR_EXPAND]: { group: "vault_legacy", trust: "client" },
  [TrackedAction.HOST_LEGACY_REQUIREMENTS_VIEW]: { group: "vault_legacy", trust: "client" },
  [TrackedAction.HOST_LEGACY_RECALCULATE_REQUEST]: { group: "vault_legacy", trust: "client" },
